...
//   // For this demo we use USD as currency
//   const currency = "usd";
...
//   // Fetch data for both coins based on selected range (days)
...
//   // OverlappingChart uses a time scale and transforms the data into {x, y} format.
//   const OverlappingChart = ({ data1, data2, label1, label2, range }) => {
//     // Transform arrays: each item is [timestamp, price]
...
//     // Configure options with a time scale for the X axis.
//     const options = {
//       responsive: true,
//       interaction: {
//         mode: "index",
...
//       {/* Overlapping chart displaying full realtime data for both coins */}
//       {!loading &&
//         chartData1.length > 0 &&
//         chartData2.length > 0 && (
//           <Box w="full" p="2">
